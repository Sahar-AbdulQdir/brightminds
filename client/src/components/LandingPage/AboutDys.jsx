          ...
          <div className="layer-text right">
            <div className="page-right-2">
              <div className="page-text w-richtext">
                ...
                <p>
                  Dslexian people often shine in ways that others might not notice right away. Some of their strengths include:
                </p>
                <ul>
                ...
                <div className="book-img-wrap">
                  {/* <img src={bookimg} className="bookimg styled-book" alt="Friendly brain diagram" /> */}
